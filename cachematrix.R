...
cacheSolve <- function(m, ...) {
    # Set matrix to NULL - this will be returned in the case of an error
    inverse <- NULL
    ...
    # If it hasn't been, calculate it and cache it
        ...
        tryCatch({
            ...
            print("Unfortunately only square matrices can be inverted")
        })
    }
  
    # Return the inverse (or NULL in case of)
    inverse
}